...
import { LayoutDashboard, Users, Tractor, MapPin, Settings, Shield, FileText } from "lucide-react"
...
const menuItems = [
    ...
    { href: "/dashboard/dominios", label: "Domínios / Itens", icon: MapPin },
    { href: "/dashboard/admins", label: "Administradores", icon: Shield },
